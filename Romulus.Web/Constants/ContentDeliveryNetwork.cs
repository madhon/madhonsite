namespace Romulus.Web.Constants
{
    public static class ContentDeliveryNetwork
    {
        ...
        public static class MaxCdn
        {
            ...
            public const string BootstrapCssUrl = "https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css";
        ...
        public static class JsDelivr
        {
            ...
            public const string ParsleyUrl = "https://cdn.jsdelivr.net/parsleyjs/2.6.2/parsley.min.js";
        }
