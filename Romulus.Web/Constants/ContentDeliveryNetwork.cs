namespace Romulus.Web.Constants
{
    public static class ContentDeliveryNetwork
    {
        ...
        {
            public const string MdlIconsUrl = "//fonts.googleapis.com/icon?family=Material+Icons";
            public const string MdlCssUrl = "//code.getmdl.io/1.1.2/material.indigo-pink.min.css";
            public const string MdlJsUrl = "//code.getmdl.io/1.1.2/material.min.js";
        }
    }
}