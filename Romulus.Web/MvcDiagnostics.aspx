...
<script runat="server">
    ...
    private static readonly MvcCoreAssemblyInfo[] _mvcCoreAssemblyHistory = new[] {
        // v1
    ...
    private static readonly MvcFuturesAssemblyInfo[] _mvcFuturesAssemblyHistory = new[] {
        ...
        new MvcFuturesAssemblyInfo() { Version = "3.0.20105.0", Name = "ASP.NET MVC 3 RTM Futures", DownloadUrl = "http://go.microsoft.com/fwlink/?LinkID=183739" }
    };
