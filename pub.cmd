...
dotnet publish --runtime win10-x64  --self-contained true -c Release /p:PublishSingleFile=true -p:PublishTrimmed=True -p:TrimMode=CopyUsed -p:_TrimmerDefaultAction=copy --output ..\madhonpub
